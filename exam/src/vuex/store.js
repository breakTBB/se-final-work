...
const state = {
    ...
    menu: [{
        ...
        },
        {
            ...
            title: '题库管理',
            icon: 'icon-tiku',
            content: [{ item2: '所有题库', path: '/selectAnswer' }, { item3: '试卷题库', path: '/addAnswer' }, { path: '/addAnswerChildren' }],
        },
        {
            index: '3',
            title: '成绩查询',
            icon: 'icon-performance',
            content: [{ item1: '学生成绩查询', path: '/allStudentsGrade' }, { path: '/grade' }, { path: '/scorePart' }],
        },
        {
            index: '4',
            title: '学生管理',
